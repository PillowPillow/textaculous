...
// version: 0.1.0
// author: 
// generated: Fri Jul 03 2015 17:07:38 GMT+0200 (Paris, Madrid (heure d’été))
...
(function (window,document,angular) {
	...
	angular.module('textaculous').run(['$templateCache', function($templateCache) {
		$templateCache.put('../lib/templates/textaculous.jade',
			'<section class="front">\n' +
			'  <textarea placeholder="{{placeholder}}" ng-click="selectText($event)" ng-model="raw" ng-trim="false" wrap="hard"></textarea>\n' +
			'</section>\n' +
			'<section class="back">\n' +
